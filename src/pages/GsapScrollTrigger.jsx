...
const GsapScrollTrigger = () => {
  ...
  // we can also do one by one child of a box but we can use utility
  const observerContainerRef = useRef();

  useGSAP(
    () => {
      const boxes = gsap.utils.toArray(observerContainerRef.current.children);
  ...
  return (
    <main>
      ...
      <div ref={observerContainerRef} className="mt-20 w-full h-screen">
        <div
          id="scroll-pink"
